...
const struct chainparams networks[] = {
    {.index = 0,
     .network_name = "c0ban",
     .bip173_name = "cb",
     .genesis_blockhash = {{{.u.u8 = {0x67, 0x4a, 0xbe, 0x73, 0x92, 0x03, 0xcd, 0x32, 0x92, 0x08, 0xb2, 0x26, 0x1d, 0x01, 0xee, 0x00, 0xb3, 0x65, 0x39, 0x7a, 0x68, 0x1e, 0x35, 0x04, 0xce, 0xff, 0x84, 0x51, 0x00, 0x00, 0x00, 0x00}}}},
     .rpc_port = 7772,
     .cli = "c0ban-cli",
     .cli_args = NULL,
     .dust_limit = 546,
